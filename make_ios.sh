...
mkdir -p Plugins/iOS/
exist_armv7=`lipo -info build_ios/Release-iphoneos/libBitPacking.a | grep armv7 | wc -l`
exist_arm64=`lipo -info build_ios/Release-iphoneos/libBitPacking.a | grep arm64 | wc -l`
if [ $[exist_armv7] -eq 0 ]; then
	...
	cp build_ios/Release-iphoneos/libBitPacking.a Plugins/iOS/libBitPacking.a
    rm -rf build_io
fi
