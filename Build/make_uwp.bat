...
md Plugins\WSA\x86
copy /Y build_uwp\Release\BitPacking.dll Plugins\WSA\x86\BitPacking.dll
rmdir /S /Q build_uwp
...
md Plugins\WSA\x64
copy /Y build_uwp64\Release\BitPacking.dll Plugins\WSA\x64\BitPacking.dll
...
md Plugins\WSA\ARM
copy /Y build_uwp_arm\Release\BitPacking.dll Plugins\WSA\ARM\BitPacking.dll
